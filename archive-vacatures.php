        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-7 col-md-6">
                    <?php $cnt = get_field('content_extra_vacatures', 'option'); ?>
                    <?php if ($cnt) { ?>
                        <div class="inf-sng">
                            <h2><?php the_field('titel_extra_vacatures', 'option'); ?></h2>
                            <?php the_field('content_extra_vacatures', 'option'); ?>
                            <?php if (have_rows('knoppen_extra_vacatures', 'option')) : ?>
                                <?php while (have_rows('knoppen_extra_vacatures', 'option')) : the_row(); ?>
