		...
		<div class="row">
			<?php if ($isTouch) { ?>
				<div class="col-xl-7 col-md-6">
					...
					<div class="uzp">
						<form class="uzp__vacancy-form vacansie_form" name="uzp__vacancy-form">
							<?php if (!isset($hide_title) || $hide_title !== true) { ?>
								<?php if (isset($view_data) && property_exists($view_data, 'data')) { ?>
									<h1><?php _e('Apply for', 'uitzendplaats'); ?> <?php echo $view_data->data->title ?></h1>
							...
							<div class="uzp__form-group uzp-row">
								<label for="inputFirstName" class="uzp__control-label"><?php _e('First name', 'uitzendplaats'); ?></label>
							...
							<div class="uzp__form-group uzp-row">
								<label for="inputPrefix" class="uzp__control-label"><?php _e('Middle name', 'uitzendplaats'); ?></label>
							...
							<div class="uzp__form-group uzp-row">
								<label for="inputLastName" class="uzp__control-label"><?php _e('Last name', 'uitzendplaats'); ?></label>
							...
							<div class="uzp__form-group uzp-row">
								<label for="inputEmail" class="uzp__control-label"><?php _e('E-mail', 'uitzendplaats'); ?></label>
							...
							<div class="uzp__form-group uzp-row">
								<label for="inputPhone" class="uzp__control-label"><?php _e('Phone number', 'uitzendplaats'); ?></label>
							...
							<div class="uzp__form-group uzp-row">
								<label for="inputCv" class=" uzp__control-label"><?php _e('Resume', 'uitzendplaats'); ?></label>
							...
							<div class="uzp__form-group uzp-row">
								<label class="uzp__control-label" for="inputMessage"><?php _e('Accompanying message', 'uitzendplaats'); ?></label>
			...
			<?php } else { ?>
				<div class="col-md-12">
					<h2><?php _e('Oeps!', 'leerbouwen'); ?></h2>
					<p><?php _e('U heeft geen vacature geselecteerd. Selecteer eerst een vacature om op te solliciteren.', 'leerbouwen'); ?></p>
					<a class="btn" href="vacatures"><?php _e('Ga naar overzicht','leerbouwen');?></a>
				</div>
			<?php } ?>
		</div>
	</div>
